...
export default function CreateNewRafflePage(props: {
  ...
  const [rewardType, setRewardType] = useState("receivenft");
        ...
        <div className="create-content">
          ...
          <div className="create-panel">
                ...
                <div className="form-control">
                  ...
                  <FormControl>
                    ...
                    >
                      ...
                      <FormControlLabel value="spl" control={<Radio />} label="$REAP" />
                    </RadioGroup>
                  </FormControl>
                </div>
              </div>
                ...
                <div className="form-control">
                  ...
                  <FormControl>
                    <RadioGroup
                      ...
                      defaultValue="receivenft"
                    >
                      <FormControlLabel value="receivenft" control={<Radio />} label="Receive NFT" />
            ...
            <div className="row">
              <div className="col-half">
                <button
                  className="btn-create-aution mt-10"
